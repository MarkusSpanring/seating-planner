#!/bin/bash
# update.command — 1-Click Update Script for Sitzplan (macOS)
...
echo "            macOS Update Manager"
echo "==================================================="
echo ""

# 1. Verify Git installation
if ! command -v git >/dev/null 2>&1; then
    echo "⚠️ Git ist auf deinem Mac nicht installiert."
    echo "Git wird benötigt, um die neuesten Updates automatisch abzurufen."
    echo ""
    echo "Apple Developer Tools werden jetzt abgefragt (oder du kannst Git direkt herunterladen)..."
    read -p "Drücke [Enter] um fortzufahren..."
    xcode-select --install 2>/dev/null || open "https://git-scm.com/download/mac"
    echo ""
    echo "Nach der Installation führe bitte update.command erneut aus."
